 ...
 * @author eriks
 */
public class MudroomToEntranceDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public MudroomToEntranceDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.mudroomToEntranceDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }
