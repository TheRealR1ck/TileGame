 ...
 * @author eriks
 */
public class EntranceToMudroomDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public EntranceToMudroomDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.entranceToMudroomDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }

    @Override
    public void die() {
        //worlds.getMudroom();
        handler.getGameState().setTheWorldPath(worlds.getMudroom());
        try {
