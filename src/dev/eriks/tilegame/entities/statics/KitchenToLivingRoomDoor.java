 ...
 * @author eriks
 */
public class KitchenToLivingRoomDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public KitchenToLivingRoomDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.kitchenToLivingRoomDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }
