 ...
 * @author eriks
 */
public class EntranceToLivingRoomDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public EntranceToLivingRoomDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.entranceToLivingRoomDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }

    @Override
    public void die() {
        //worlds.getMudroom();
        handler.getGameState().setTheWorldPath(worlds.getLivingroom());
        try {
