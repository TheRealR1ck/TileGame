 ...
 * @author eriks
 */
public class LivingRoomToKitchenDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public LivingRoomToKitchenDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.livingRoomToKitchenDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }

    @Override
    public void die() {
        //worlds.getMudroom();
        handler.getGameState().setTheWorldPath(worlds.getKitchen());
        try {
