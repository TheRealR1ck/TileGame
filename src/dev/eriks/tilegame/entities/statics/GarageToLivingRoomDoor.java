 ...
 * @author eriks
 */
public class GarageToLivingRoomDoor extends StaticEntity {

    public TheWorlds worlds = new TheWorlds();

    public GarageToLivingRoomDoor(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.garageToLivingRoomDoor, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
    }
